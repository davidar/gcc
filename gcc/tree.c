...
ix86_builtins2gsbi_ts (enum ix86_builtins code) 
{
  switch (code) {
    ...
    case IX86_BUILTIN_BLENDVPS: return GSBI_IX86_BUILTIN_BLENDVPS;
		case IX86_BUILTIN_ROUNDPD: return GSBI_IX86_BUILTIN_ROUNDPD;
		case IX86_BUILTIN_ROUNDSD: return GSBI_IX86_BUILTIN_ROUNDSD;
		case IX86_BUILTIN_ROUNDPS: return GSBI_IX86_BUILTIN_ROUNDPS;
		case IX86_BUILTIN_ROUNDSS: return GSBI_IX86_BUILTIN_ROUNDSS;
	  ...
	  case IX86_BUILTIN_PEXTRB: return GSBI_IX86_BUILTIN_PEXTRB;
	  case IX86_BUILTIN_PEXTRD: return GSBI_IX86_BUILTIN_PEXTRD;
	  case IX86_BUILTIN_PEXTRQ: return GSBI_IX86_BUILTIN_PEXTRQ;
	  case IX86_BUILTIN_EXTRACTPS: return GSBI_IX86_BUILTIN_EXTRACTPS;
	  case IX86_BUILTIN_PINSRB: return GSBI_IX86_BUILTIN_PINSRB;
	  case IX86_BUILTIN_PINSRD: return GSBI_IX86_BUILTIN_PINSRD;
	  case IX86_BUILTIN_PINSRQ: return GSBI_IX86_BUILTIN_PINSRQ;
	  case IX86_BUILTIN_INSERTPS: return GSBI_IX86_BUILTIN_INSERTPS;
    ...
    case IX86_BUILTIN_MOVNTDQA: return GSBI_IX86_BUILTIN_MOVNTDQA;
	  case IX86_BUILTIN_PTESTC128: return GSBI_IX86_BUILTIN_PTESTC128;
	  case IX86_BUILTIN_PTESTNZC128: return GSBI_IX86_BUILTIN_PTESTNZC128;
	  case IX86_BUILTIN_PTESTZ128: return GSBI_IX86_BUILTIN_PTESTZ128;
		case IX86_BUILTIN_PCMPESTRIA128: return GSBI_IX86_BUILTIN_PCMPESTRIA128;
		case IX86_BUILTIN_PCMPESTRIC128: return GSBI_IX86_BUILTIN_PCMPESTRIC128;
		...
		case IX86_BUILTIN_PCMPESTRIO128: return GSBI_IX86_BUILTIN_PCMPESTRIO128;
		case IX86_BUILTIN_PCMPESTRIS128: return GSBI_IX86_BUILTIN_PCMPESTRIS128;
		case IX86_BUILTIN_PCMPESTRIZ128: return GSBI_IX86_BUILTIN_PCMPESTRIZ128;
		case IX86_BUILTIN_PCMPGTQ128: return GSBI_IX86_BUILTIN_PCMPGTQ128;
		case IX86_BUILTIN_PCMPISTRIA128: return GSBI_IX86_BUILTIN_PCMPISTRIA128;
		case IX86_BUILTIN_PCMPISTRIC128: return GSBI_IX86_BUILTIN_PCMPISTRIC128;
		...
		case IX86_BUILTIN_PCMPISTRIO128: return GSBI_IX86_BUILTIN_PCMPISTRIO128;
		case IX86_BUILTIN_PCMPISTRIS128: return GSBI_IX86_BUILTIN_PCMPISTRIS128;
		case IX86_BUILTIN_PCMPISTRIZ128: return GSBI_IX86_BUILTIN_PCMPISTRIZ128;
		case IX86_BUILTIN_CRC32B: return GSBI_IX86_BUILTIN_CRC32B;
		case IX86_BUILTIN_CRC32W: return GSBI_IX86_BUILTIN_CRC32W;
		case IX86_BUILTIN_CRC32L: return GSBI_IX86_BUILTIN_CRC32L;
		case IX86_BUILTIN_CRC32Q: return GSBI_IX86_BUILTIN_CRC32Q;
...
gs_x_1 (tree t, HOST_WIDE_INT seq_num)
{
  ...
  if ((gs_t) GS_NODE (t) != (gs_t) NULL) {
    ...
    if (TREE_CODE(t) == FUNCTION_DECL) {
      ...
      // Bug 14649: If this function was processed earlier as a built-in,
      // but now has been resolved to a non-built-in, reset the built-in
      // flag and process it again.
      gs_flags = gs_operand((gs_t)GS_NODE(t), GS_FLAGS);
      if (gs_bv(gs_flags, GS_DECL_BUILT_IN) && !DECL_BUILT_IN(t)) {
        _gs_bv_reset(gs_flags, GS_DECL_BUILT_IN);
          goto REVISIT;
      }
  ...
  GS_ASSERT(!(TREE_CODE(t) == FUNCTION_DECL &&
	      FULLY_TRANSLATED_TO_GS(t)) || CPR() || translate_this_func_decl,
  ...
  switch (TREE_CODE_CLASS (TREE_CODE (t)))
	...
	case RECORD_TYPE:
	  ...
	  if (CPR()) {
	      ...
	      // sct 6170: Should not compute aggregate_value_p for a
	      // type that is really a template type, and has not yet been
	      // instantiated, because its fields may not have been laid
	      // out properly (no offset information)
	      int aggr_type_laid_out = true;
	      tree type = t;
	      // sct 7079: check if the current type is not itself a
	      // template type, but is nested within a template type.
	      while (type && IS_AGGR_TYPE_CODE(TREE_CODE(type))) {
	        if (CLASS_TYPE_P(type) && CLASSTYPE_IS_TEMPLATE(type)) {
		  aggr_type_laid_out = false;
		  break;
		}
		type = TYPE_CONTEXT(type);
	      }
	      if (aggr_type_laid_out) {
	        /* sct 5854: we may have previously set this flag based on
	           an incomplete type, so be prepared to reset the flag */
	        int aggr_value = aggregate_value_p (t, NULL);
	        _gs_bv(flags, GS_AGGREGATE_VALUE_P, aggr_value);
	        if (! aggr_value && gs_bv(flags, GS_AGGREGATE_VALUE_P))
	          _gs_bv_reset (flags, GS_AGGREGATE_VALUE_P);
	      }
	  }
	  /* fall through */
