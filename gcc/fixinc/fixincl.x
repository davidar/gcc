...
/* * * * * * * * * * * * * * * * * * * * * * * * * *
 *
 *  Description of Llvm_Inline_Asm_Linux fix
 */
tSCC zLlvm_Inline_Asm_LinuxName[] =
     "llvm_inline_asm_linux";

/*
 *  File name selection pattern
 */
tSCC zLlvm_Inline_Asm_LinuxList[] =
  "|bits/select.h|bits/byteswap.h|";
/*
 *  Machine/OS name selection pattern
 */
tSCC* apzLlvm_Inline_Asm_LinuxMachs[] = {
        "i[34567]86-*-linux*",
        (const char*)NULL };
 ...
 */
tSCC zLlvm_Inline_Asm_LinuxSelect0[] =
       "^#if defined __GNUC__ && __GNUC__ >= 2";

#define    LLVM_INLINE_ASM_LINUX_TEST_CT  1
static tTestDesc aLlvm_Inline_Asm_LinuxTests[] = {
  { TT_EGREP,    zLlvm_Inline_Asm_LinuxSelect0, (regex_t*)NULL }, };

/*
 *  Fix Command Arguments for Llvm_Inline_Asm_Linux
 */
static const char* apzLlvm_Inline_Asm_LinuxPatch[] = {
    "format",
...
tFixDesc fixDescList[ FIX_COUNT ] = {
  {  zLlvm_Inline_Asm_LinuxName,    zLlvm_Inline_Asm_LinuxList,
     apzLlvm_Inline_Asm_LinuxMachs,
